...
class Legal: UIViewController  {
	...
	override func viewDidLoad() {
		...
		bodyCopy.frame = CGRectMake(marginRight, racingHeader.frame.height, screen.width - (marginRight * 2), screen.height - (racingHeader.frame.height + 60))
		bodyCopy.contentSize = CGSize(width: screen.width - (marginRight * 2), height: 2000)
		self.view.addSubview(bodyCopy)
		
		let title = UILabel()
		title.frame = CGRectMake(0, 0, bodyCopy.frame.width, 300)
		title.textColor = UIColor.whiteColor()
		title.text = "FSDDSFDSFDSFDSFSDF SFSDFDSFDSFDSFD FSDDSFDSFDSFDSFSDF SFSDFDSFDSFDSFD FSDDSFDSFDSFDSFSDF SFSDFDSFDSFDSFD FSDDSFDSFDSFDSFSDF SFSDFDSFDSFDSFD FSDDSFDSFDSFDSFSDF SFSDFDSFDSFDSFD FSDDSFDSFDSFDSFSDF SFSDFDSFDSFDSFD FSDDSFDSFDSFDSFSDF SFSDFDSFDSFDSFD FSDDSFDSFDSFDSFSDF SFSDFDSFDSFDSFD "
		title.numberOfLines = 0
		bodyCopy.addSubview(title)
		
		let bottomButtonContainer = UIView()
		bottomButtonContainer.frame = CGRectMake(marginRight, screen.height - 80, screen.width - (marginRight * 2), 80)
		bottomButtonContainer.backgroundColor = UIColor.blackColor()
		self.view.addSubview(bottomButtonContainer)
		
		let exitButton = UIButton()
		exitButton.frame = CGRectMake(0, 10, (bottomButtonContainer.frame.width * 0.5) - 10, 50)
		...
		acceptButton.frame = CGRectMake(bottomButtonContainer.frame.width - exitButton.frame.width, 10, (bottomButtonContainer.frame.width * 0.5) - 10, 50)
	...
	//	let viewController:UIViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("LandingPageNew")
