...
class NoDealer: UIView {
	...
	override func didMoveToSuperview() {
		...
		let body = UILabel()
		body.text = "You have not explored any dealers"
		...
		exitButton.frame = CGRectMake( 127 , mainCountainer.frame.height - 90, 127,60)
		exitButton.addTarget(self, action: "exit:", forControlEvents: UIControlEvents.TouchUpInside)
		exitButton.setImage(UIImage(named: "accept"), forState: .Normal)
		mainCountainer.addSubview(exitButton)
		*/
		
		let acceptButton = UIButton()
		acceptButton.frame = CGRectMake((mainCountainer.frame.width * 0.5) - 63, mainCountainer.frame.height - 90, 127,60)
		acceptButton.addTarget(self, action: "exit:", forControlEvents: UIControlEvents.TouchUpInside)
